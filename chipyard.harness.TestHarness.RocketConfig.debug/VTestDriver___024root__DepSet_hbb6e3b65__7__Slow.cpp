...
VL_ATTR_COLD void VTestDriver___024root___eval_initial__TOP__261(VTestDriver___024root* vlSelf) {
    ...
    while ((0x125U > (IData)(vlSelf->TestDriver__DOT__testHarness__DOT__chiptop0__DOT__system__DOT__cbus__DOT__in_xbar__DOT__monitor__DOT__unnamedblk1__DOT__i))) {
        vlSelf->TestDriver__DOT__testHarness__DOT__chiptop0__DOT__system__DOT__cbus__DOT__in_xbar__DOT__monitor__DOT____Vlvbound_h278d1e7c__0 
            = VL_RANDOM_I();
        if (VL_LIKELY((0x124U >= (IData)(vlSelf->TestDriver__DOT__testHarness__DOT__chiptop0__DOT__system__DOT__cbus__DOT__in_xbar__DOT__monitor__DOT__unnamedblk1__DOT__i)))) {
