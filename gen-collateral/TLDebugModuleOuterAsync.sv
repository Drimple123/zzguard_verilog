...
module TLDebugModuleOuterAsync(
  ...
  TLXbar_12 dmiXbar (	// @[generators/rocket-chip/src/main/scala/devices/debug/Debug.scala:670:28]
    .clock                     (io_dmi_clock),
    .reset                     (io_dmi_reset),
  ...
  IntSyncCrossingSource_12 intsource (	// @[generators/rocket-chip/src/main/scala/interrupts/Crossing.scala:28:31]
  ...
  TLAsyncCrossingSource_4 asource (	// @[generators/rocket-chip/src/main/scala/tilelink/AsyncCrossing.scala:89:29]
    .clock                          (io_dmi_clock),
    .reset                          (io_dmi_reset),
  ...
  AsyncResetSynchronizerShiftReg_w1_d3_i0_80 dmactiveAck_dmactiveAckSync (	// @[generators/rocket-chip/src/main/scala/util/ShiftReg.scala:45:23]
    .clock (io_dmi_clock),
    .reset (io_dmi_reset),
    .io_d  (io_ctrl_dmactiveAck),
    .io_q  (_dmactiveAck_dmactiveAckSync_io_q)
  );
  AsyncQueueSource_11 io_innerCtrl_source (	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:216:24]
    .clock                        (io_dmi_clock),
    .reset                        (io_dmi_reset),
