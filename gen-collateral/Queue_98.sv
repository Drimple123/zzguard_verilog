...
module Queue_98(
  ...
  input  [6:0]  io_enq_bits_tag,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  output [6:0]  io_deq_bits_tag,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  ram_16x62 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_sdq_id, io_enq_bits_dprv, io_enq_bits_signed, io_enq_bits_size, io_enq_bits_cmd, io_enq_bits_tag, io_enq_bits_addr})	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  );
  ...
  assign io_deq_bits_tag = _ram_ext_R0_data[46:40];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_cmd = _ram_ext_R0_data[51:47];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_size = _ram_ext_R0_data[53:52];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_signed = _ram_ext_R0_data[54];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_dprv = _ram_ext_R0_data[56:55];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_sdq_id = _ram_ext_R0_data[61:57];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule
