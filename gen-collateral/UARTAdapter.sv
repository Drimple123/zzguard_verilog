...
module UARTAdapter(
  ...
  Queue_149 txq (	// @[generators/testchipip/src/main/scala/uart/SimUART.scala:36:19]
    .clock        (clock),
    .reset        (reset),
  ...
  Queue_149 rxq (	// @[generators/testchipip/src/main/scala/uart/SimUART.scala:38:19]
    .clock        (clock),
    .reset        (reset),
