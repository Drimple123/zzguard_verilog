...
module Asan_Imp_new_1(
  ...
  wire        _addr_fifo_io_deq_ready_T_1 = io_valid_mem & io_resp_tag == 8'h3;	// @[generators/rocket-chip/src/main/scala/zzguard_rr/asan.scala:80:{44,60}, :143:28]
  reg  [39:0] offset;	// @[generators/rocket-chip/src/main/scala/zzguard_rr/asan.scala:116:25]
  wire [39:0] fifo_addr = {5'h0, io_din_bits[103:69]} + offset;	// @[generators/rocket-chip/src/main/scala/zzguard_rr/asan.scala:67:32, :116:25, :126:32, :129:{29,37}, :142:28]
  ...
  assign io_mem_acc_io_bits_tag = 8'h3;	// @[generators/rocket-chip/src/main/scala/zzguard_rr/asan.scala:143:28]
