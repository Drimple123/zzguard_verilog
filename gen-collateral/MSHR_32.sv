...
module MSHR_32(
  ...
  input  [6:0]  io_req_bits_tag,	// @[generators/rocket-chip/src/main/scala/rocket/NBDcache.scala:145:14]
  ...
  output [6:0]  io_replay_bits_tag,	// @[generators/rocket-chip/src/main/scala/rocket/NBDcache.scala:145:14]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_cmd = _RANDOM[2'h1][23:19];	// @[generators/rocket-chip/src/main/scala/rocket/NBDcache.scala:170:16]
        req_old_meta_coh_state = _RANDOM[2'h2][8:7];	// @[generators/rocket-chip/src/main/scala/rocket/NBDcache.scala:170:16]
        req_old_meta_tag = _RANDOM[2'h2][28:9];	// @[generators/rocket-chip/src/main/scala/rocket/NBDcache.scala:170:16]
        req_way_en = {_RANDOM[2'h2][31:29], _RANDOM[2'h3][0]};	// @[generators/rocket-chip/src/main/scala/rocket/NBDcache.scala:170:16]
        new_coh_state = _RANDOM[2'h3][2:1];	// @[generators/rocket-chip/src/main/scala/rocket/NBDcache.scala:170:16, :176:24]
        counter = _RANDOM[2'h3][11:3];	// @[generators/rocket-chip/src/main/scala/rocket/NBDcache.scala:170:16, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:230:27]
        acked = _RANDOM[2'h3][12];	// @[generators/rocket-chip/src/main/scala/rocket/NBDcache.scala:170:16, :199:18]
        meta_hazard = _RANDOM[2'h3][14:13];	// @[generators/rocket-chip/src/main/scala/rocket/NBDcache.scala:170:16, :272:28]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_98 rpq (	// @[generators/rocket-chip/src/main/scala/rocket/NBDcache.scala:194:19]
    .clock                (clock),
    .reset                (reset),
