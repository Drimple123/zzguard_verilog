...
VL_INLINE_OPT void VTestDriver___024root___nba_sequent__TOP__2985(VTestDriver___024root* vlSelf) {
    ...
    } else if (vlSelf->TestDriver__DOT__testHarness__DOT__chiptop0__DOT__system__DOT__coh_wrapper__DOT__l2__DOT__inclusive_cache_bank_sched__DOT__sinkD__DOT__d_q__DOT__do_deq) {
...
VL_INLINE_OPT void VTestDriver___024root___nba_sequent__TOP__2990(VTestDriver___024root* vlSelf) {
    ...
    // Body
    __Vtemp_5[0U] = ((IData)(vlSelf->TestDriver__DOT__testHarness__DOT__chiptop0__DOT__system__DOT__bank__DOT__fragmenter__DOT__monitor__DOT___GEN_1)
